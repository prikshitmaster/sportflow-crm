// Deletes everything created under the QA academy, in FK-safe order, then
// prints row counts removed. Scoped tightly to state.academyId / ownerId —
// never touches anything outside this session's own test data.
import fs from 'fs'
...
console.log(`Cleaning up QA academy ${academyId} (owner ${ownerId})`)
