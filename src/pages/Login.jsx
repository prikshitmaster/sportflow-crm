      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-gray-900 via-brand-900 to-gray-900 items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative max-w-md text-white">
          <div className="text-4xl font-black mb-6 leading-tight">
            ...
            <span className="text-brand-400">academy in one place</span>
          </div>
          <p className="text-gray-300 text-sm leading-relaxed mb-8">
            Students, fees, attendance, batches, staff, and reports — all in one powerful dashboard.
          </p>
          <div className="space-y-3">
            {[
              'Student management & fee tracking',
              'Attendance & batch scheduling',
              'Payment reports & overdue alerts',
            ].map(f => (
