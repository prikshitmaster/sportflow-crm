...
function TopBar({ title, subtitle, onBack, right, progress, sticky }) {
  return (
    <div style={{
      ...
      background: '#fff', borderBottom: `1px solid ${N.line}`,
      padding: progress != null
        ? 'calc(12px + max(env(safe-area-inset-top, 0px), var(--safe-area-inset-top, 0px))) 16px 0'
        : 'calc(12px + max(env(safe-area-inset-top, 0px), var(--safe-area-inset-top, 0px))) 16px 14px',
    }}>
        ...
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(19,26,43,0.5)', display: 'flex', alignItems: 'flex-end', justifyContent: 'center', zIndex: 50 }}
          ...
          <div onClick={e => e.stopPropagation()}
            style={{ width: '100%', maxWidth: 440, background: '#fff', borderRadius: `${R.tile}px ${R.tile}px 0 0`,
                     padding: '18px 20px calc(24px + env(safe-area-inset-bottom, var(--safe-area-inset-bottom, 0px)))', boxSizing: 'border-box',
    ...
    return (
      <div style={{ minHeight: '100vh', background: N.page, fontFamily: FONT,
        ...
        <div className="jf-shell" style={{ margin: '0 auto', width: '100%', maxWidth: 440, position: 'relative', overflow: 'hidden', background: C.deep }}>
          ...
          <div className="jf-fwd" style={{ position: 'absolute', top: 'calc(54px + max(env(safe-area-inset-top, 0px), var(--safe-area-inset-top, 0px)))', left: 22, right: 22, display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <div style={{ position: 'absolute', left: 0, right: 0, bottom: 0, background: '#fff',
                        borderRadius: `${R.tile}px ${R.tile}px 0 0`, padding: '20px 20px calc(24px + env(safe-area-inset-bottom, var(--safe-area-inset-bottom, 0px)))' }}>
      ...
      <div className="jf-shell" style={{ margin: '0 auto', width: '100%', maxWidth: 440, display: 'flex', flexDirection: 'column', background: N.page, position: 'relative', overflow: 'hidden' }}>
        <div ref={scrollRef} className="jf-scroll" style={{ flex: 1, overflowY: 'auto', overflowX: 'hidden' }}>
          <div key={navSeq} className={screenAnim}>
              ...
              <>
                <div style={{ position: 'sticky', top: 0, zIndex: 5, background: 'rgba(246,247,250,0.86)',
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10,
                                padding: 'calc(12px + max(env(safe-area-inset-top, 0px), var(--safe-area-inset-top, 0px))) 16px 10px' }}>
            ...
            {step === 'home' && homeTab === 'sessions' && (
              !isAuthed ? (
                <div style={{ padding: 'calc(28px + max(env(safe-area-inset-top, 0px), var(--safe-area-inset-top, 0px))) 16px 24px' }}>
                ...
                <div style={{ padding: 'calc(16px + max(env(safe-area-inset-top, 0px), var(--safe-area-inset-top, 0px))) 16px 24px' }}>
            ...
            {step === 'home' && homeTab === 'academy' && (
              <div style={{ padding: 'calc(18px + max(env(safe-area-inset-top, 0px), var(--safe-area-inset-top, 0px))) 16px 24px' }}>
              ...
              <>
                <div style={{ position: 'relative', height: 188, background: N.hair }}>
                  ...
                  <Tappable onClick={goHome} label="Back to sports" press="chip"
                    style={{ position: 'absolute', top: 'calc(14px + max(env(safe-area-inset-top, 0px), var(--safe-area-inset-top, 0px)))', left: 14, width: 34, height: 34, borderRadius: R.control,
        ...
        {showTabBar && (
          <div style={{ flexShrink: 0, background: 'rgba(255,255,255,0.94)',
                        backdropFilter: 'saturate(180%) blur(20px)', WebkitBackdropFilter: 'saturate(180%) blur(20px)',
                        borderTop: `1px solid ${N.line}`, padding: '7px 20px calc(8px + env(safe-area-inset-bottom, var(--safe-area-inset-bottom, 0px)))',
        ...
        {step === 'form' && (
          <div style={{ flexShrink: 0, background: '#fff', borderTop: `1px solid ${N.line}`,
                        padding: '10px 16px calc(12px + env(safe-area-inset-bottom, var(--safe-area-inset-bottom, 0px)))',
