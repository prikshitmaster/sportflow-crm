...
function TopBar({ title, subtitle, onBack, C, children }) {
  return (
    <div style={{ background: '#fff', padding: 'calc(56px + max(env(safe-area-inset-top, 0px), var(--safe-area-inset-top, 0px))) 22px 20px', borderRadius: `0 0 ${R.sheet}px ${R.sheet}px`, boxShadow: E.rest }}>
      ...
      <div style={{ margin: '0 auto', width: '100%', maxWidth: 440, minHeight: '100dvh', position: 'relative', overflow: 'hidden', background: N.page }}>
        ...
        {step === 'login' && (
          <div className="jf-screen" style={{ minHeight: '100dvh', position: 'relative', overflow: 'hidden', background: '#0B1F12' }}>
            ...
            <div style={{ position: 'absolute', top: 'calc(58px + max(env(safe-area-inset-top, 0px), var(--safe-area-inset-top, 0px)))', left: 24, right: 24, display: 'flex', flexDirection: 'column', gap: 14 }}>
              {branding?.logoUrl ? (
        ...
        {step === 'home' && (<>
          <div className="jf-screen" style={{ minHeight: '100dvh', position: 'relative' }}>
            <div style={{ minHeight: '100dvh', overflowY: 'auto' }}>
              ...
              <div style={{ position: 'sticky', top: 0, zIndex: 15, background: `linear-gradient(160deg, ${C.main} 0%, ${C.dark} 100%)`, padding: 'calc(56px + max(env(safe-area-inset-top, 0px), var(--safe-area-inset-top, 0px))) 22px 28px', borderRadius: '0 0 32px 32px' }}>
