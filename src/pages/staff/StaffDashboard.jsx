...
import { CalendarCheck, Users, ChevronRight, Bell } from 'lucide-react'
import { useEffect } from 'react'

export default function StaffDashboard() {
  const { user, batches, students, attendanceData, leaveRequests, loadLeaveRequests, dataLoading } = useApp()
