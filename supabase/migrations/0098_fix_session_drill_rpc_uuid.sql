...
BEGIN
  ...
  UPDATE drills d SET
    ...
    equipment   = COALESCE(p_payload->'equipment',    d.equipment),
    ...
    procedure   = COALESCE(p_payload->'procedure',    d.procedure),
    coaching_points = COALESCE(p_payload->'coaching_points', d.coaching_points),
    progressions  = COALESCE(p_payload->'progressions',  d.progressions),
    regressions   = COALESCE(p_payload->'regressions',   d.regressions),
    objectives    = COALESCE(p_payload->'objectives',    d.objectives),
...
BEGIN
  ...
  UPDATE session_plans sp SET
    ...
    equipment    = COALESCE(p_payload->'equipment',     sp.equipment),
